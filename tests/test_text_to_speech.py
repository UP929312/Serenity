...
def test_text_to_speech_failure_1() -> None:
    assert convert_text_to_speech(TEST_PROMPT_1, voice_type="young-female-british", play_message=False) is not None


def test_text_to_speech_failure_2() -> None:  # Example sentence
    assert convert_text_to_speech(TEST_PROMPT_2, voice_type="young-female-british", play_message=False) is not None
