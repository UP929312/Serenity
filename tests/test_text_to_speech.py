...
def test_text_to_speech_failure_1() -> None:
    assert convert_text_to_speech(TEST_PROMPT_1, False) is None  # type: ignore[func-returns-value]


def test_text_to_speech_failure_2() -> None:  # Example sentence
    assert convert_text_to_speech(TEST_PROMPT_2, False) is None  # type: ignore[func-returns-value]
