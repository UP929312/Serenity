...
def convert_text_to_speech(text: str, voice_type: str, play_message: bool, file_name: str | None = None) -> bytes:
    ...
    audio = generate(text=text, voice=VOICE_IDS[voice_type][api_key])
...
if __name__ == "__main__":
    ...
    start = time.time()
    convert_text_to_speech(script_text, voice_type="young-female-british", play_message=False, file_name="assets/audio/test.mp3")
    #generate_voices()
    end = time.time()
